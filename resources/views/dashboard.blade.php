...
@section('title', 'Dashboard - Dr Lab LIMS')
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-16">
                <div class="flex items-center">
                    <h1 class="text-xl font-semibold text-gray-900">Dr Lab LIMS</h1>
                </div>
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <div class="flex items-center space-x-3">
                        <div class="text-right">
                            ...
                            <p class="text-xs text-gray-500">{{ auth()->user()->getUserTypeLabel() }}</p>
                        </div>
        ...
        <div class="bg-white overflow-hidden shadow rounded-lg mb-6">
            <div class="px-4 py-5 sm:p-6">
                ...
                <p class="text-sm text-gray-600">
                    Welcome to the Dr Lab Laboratory Information Management System. Use the navigation below to access different areas of the system.
                </p>
            </div>
        </div>
                        ...
                        <div class="ml-5 w-0 flex-1">
                            <dl>
                                ...
                                <dd class="text-lg font-medium text-gray-900">
                                    {{ auth()->user()->account_is_set ? 'Active' : 'Setup Needed' }}
                                </dd>
                            </dl>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="ml-5 w-0 flex-1">
                            <dl>
                                ...
                                <dd class="text-lg font-medium text-gray-900">{{ auth()->user()->getUserTypeLabel() }}</dd>
                            </dl>
                        </div>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
                        ...
                        <a href="/admin" 
                           class="relative rounded-lg border border-gray-300 bg-white px-6 py-5 shadow-sm flex items-center space-x-3 hover:border-gray-400 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
                            ...
                            <div class="flex-1 min-w-0">
                                ...
                                <p class="text-sm text-gray-500">Access full admin controls</p>
                            </div>
                        </a>
                    @endif
                    ...
                    <a href="#" 
                       class="relative rounded-lg border border-gray-300 bg-white px-6 py-5 shadow-sm flex items-center space-x-3 hover:border-gray-400 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
                        ...
                        <div class="flex-1 min-w-0">
                            <span class="absolute inset-0" aria-hidden="true"></span>
                            <p class="text-sm font-medium text-gray-900">Lab Reports</p>
                            <p class="text-sm text-gray-500">View laboratory reports</p>
                        </div>
                    </a>
                    ...
                    <a href="#" 
                       class="relative rounded-lg border border-gray-300 bg-white px-6 py-5 shadow-sm flex items-center space-x-3 hover:border-gray-400 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
                        ...
                        <div class="flex-1 min-w-0">
                            <span class="absolute inset-0" aria-hidden="true"></span>
                            <p class="text-sm font-medium text-gray-900">Lab Equipment</p>
                            <p class="text-sm text-gray-500">Manage lab equipment</p>
                        </div>
                    </a>
                </div>
            </div>
