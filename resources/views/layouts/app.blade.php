...
<head>
    ...
    <title>@yield('title', 'Dr Lab LIMS')</title>
...
<body class="font-sans antialiased">
    ...
    @if(session('warning'))
        <div x-data="{ show: true }" 
             ...
             x-transition 
             x-init="setTimeout(() => show = false, 5000)"
             class="fixed top-4 right-4 z-50 bg-yellow-100 border border-yellow-400 text-yellow-700 px-4 py-3 rounded shadow-lg">
            <div class="flex items-center">
                <svg class="w-5 h-5 mr-2" fill="currentColor" viewBox="0 0 20 20">
    ...
    @if(session('info'))
        <div x-data="{ show: true }" 
             ...
             x-transition 
             x-init="setTimeout(() => show = false, 5000)"
             class="fixed top-4 right-4 z-50 bg-blue-100 border border-blue-400 text-blue-700 px-4 py-3 rounded shadow-lg">
            <div class="flex items-center">
                <svg class="w-5 h-5 mr-2" fill="currentColor" viewBox="0 0 20 20">
